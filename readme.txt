...
Tags: freemius, sso, single sign-on, customer portal, users dashboard, members dashboard, customers dashboard, members area
...
When embedding the Customer Portal (https://github.com/Freemius/freemius-users-dashboard), a logged in user will be automatically logged into their Freemius Customer Portal without the need to manually log in.
...
=1.1.0=
* Added integration with Freemius Customer Portal plugin.
